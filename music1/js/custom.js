				...
				ready: function () {
					$(this).jPlayer("setMedia", {
						title:"Over The Horizon",
							artist:"Agam",
							mp3:"files/Over the Horizon.mp3"
					});
				},
	...
	function initAlbumPlayer()
	{
		if($('#jplayer_2').length)
		{
			...
			[
				...
				{
					title:"Over The Horizon",
					artist:"Agam the band",
					album:"Dream To Remember",
					mp3:"files/bensound-dubstep.mp3",
					poster:"images/featured_2.jpg"
				},
				{
					title:"Cloud 8.9",
					artist:"Pineapple Express",
					album:"Electric Fusion",
					mp3:"files/bensound-sunny.mp3",
					poster:"images/featured_3.jpg"
				},
				{
					title:"Manava",
					artist:"Sanjay Subramanya",
					album:"First Edition Arts",
					mp3:"files/bensound-betterdays.mp3",
