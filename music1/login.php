		...
		<div class="home_container">
			<div class="container">
				...
				<div class="contact_form_container"  style="margin-left:400px;text-align:center;padding-bottom:100px;padding-top:100px;">
						<form method="post" action="index.php" class="contact_form" id="contact_form" >
							<div>
								<div class="row">
									<div class="col-md-12 contact_input_col"><input type="text" name="username" class="contact_input" placeholder="Username" required="required"></div>
								</div>
							</div>
							<div><input type="password" class="contact_input" name="password" placeholder="Password" required="required"></div>
							<button type="submit" class="button contact_form_button" style="width:350pt;"><span>login</span></button>
						</form>
					</div>
				</div>
